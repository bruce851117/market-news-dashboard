...
def build_news_prompt(batch):
    ...
    prompt += "請依照以下範例新聞(使用者挑選過認為重要的，來當作其中一個判斷依據：1.Hammack表示通膨依然過高且廣泛蔓延，Fed可能需要考慮進一步加息。2.报道称Meta筹划进军云计算市场，以出售富余的AI算力资源，Meta股价大涨8.8%。3.Hammack表示通膨依然過高且廣泛蔓延，Fed可能需要考慮進一步加息。\n"
